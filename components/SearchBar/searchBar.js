...
const searchBar = () => {
    return (
        <div className={SearchBarStyles.SearchBar}>
            <input className={SearchBarStyles.SearchBar__Field}/>
            <div className={SearchBarStyles.SearchBar__Icon}>
            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="search" class="svg-inline--fa fa-search fa-w-16" role="img" 
            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M505 442.7L405.3 
